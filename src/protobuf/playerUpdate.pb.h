...
#ifndef PROTOBUF_INCLUDED_playerUpdate_2eproto
#define PROTOBUF_INCLUDED_playerUpdate_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_playerUpdate_2eproto 
...
namespace google {
namespace protobuf {
template<> ::gamemessages::HitBox* Arena::CreateMaybeMessage<::gamemessages::HitBox>(Arena*);
template<> ::gamemessages::PlayerUpdate* Arena::CreateMaybeMessage<::gamemessages::PlayerUpdate>(Arena*);
template<> ::gamemessages::Point* Arena::CreateMaybeMessage<::gamemessages::Point>(Arena*);
template<> ::gamemessages::PositionUpdate* Arena::CreateMaybeMessage<::gamemessages::PositionUpdate>(Arena*);
template<> ::gamemessages::TestMessage* Arena::CreateMaybeMessage<::gamemessages::TestMessage>(Arena*);
template<> ::gamemessages::Unit* Arena::CreateMaybeMessage<::gamemessages::Unit>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace gamemessages {
...
class Unit : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:gamemessages.Unit) */ {
 public:
  ...
  private:
  const ::gamemessages::Point& _internal_position() const;
  public:
  ...
  private:
  const ::gamemessages::Point& _internal_velocity() const;
  public:
...
class HitBox : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:gamemessages.HitBox) */ {
 public:
  ...
  inline HitBox* New() const final {
    return CreateMaybeMessage<HitBox>(NULL);
  }

  HitBox* New(::google::protobuf::Arena* arena) const final {
...
class PlayerUpdate : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:gamemessages.PlayerUpdate) */ {
 public:
  ...
  inline PlayerUpdate* New() const final {
    return CreateMaybeMessage<PlayerUpdate>(NULL);
  }

  PlayerUpdate* New(::google::protobuf::Arena* arena) const final {
  ...
  private:
  const ::gamemessages::Unit& _internal_player() const;
  public:
...
inline const ::gamemessages::Point& Unit::_internal_position() const {
  return *position_;
}
...
inline ::gamemessages::Point* Unit::mutable_position() {
  set_has_position();
  if (position_ == NULL) {
    auto* p = CreateMaybeMessage<::gamemessages::Point>(GetArenaNoVirtual());
    position_ = p;
  }
...
inline const ::gamemessages::Point& Unit::_internal_velocity() const {
  return *velocity_;
}
...
inline const ::gamemessages::Unit& PlayerUpdate::_internal_player() const {
  return *player_;
}
...
inline ::gamemessages::Unit* PlayerUpdate::mutable_player() {
  set_has_player();
  if (player_ == NULL) {
    auto* p = CreateMaybeMessage<::gamemessages::Unit>(GetArenaNoVirtual());
    player_ = p;
  }
...
#endif  // PROTOBUF_INCLUDED_playerUpdate_2eproto
